<template>
    <div class="carousel-item">
        <div class="title">Create Parameters of Product</div>
        ...
        <div class="container">
         ...
         <bottomBar v-if="isc" text="Create <strong> Parameters of Product</strong>" @tonext="$emit('toSecondSlide')" :next="true"/>
    </div>
</template>

<script>
import bottomBar from './bottom-bar.vue'
import InputSelect from './input-4.vue'
